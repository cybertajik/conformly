...
@compliance_router.get(
    "/evidence", response_model=list[EvidenceResponse], dependencies=[require_evidence]
)
def list_evidence(
    principal: CurrentPrincipal,
    tenant: CurrentTenant,
...
@compliance_router.get(
    "/evidence/{evidence_id}", response_model=EvidenceResponse, dependencies=[require_evidence]
)
def get_evidence(
    evidence_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.delete(
    "/evidence/{evidence_id}/files/{file_id}",
...
@compliance_router.post(
    "/evidence/{evidence_id}/controls",
    response_model=EvidenceControlLinkResponse,
    dependencies=[require_evidence],
)
...
@compliance_router.get(
    "/policies", response_model=list[PolicyResponse], dependencies=[require_policies]
)
def list_policies(
    principal: CurrentPrincipal,
    tenant: CurrentTenant,
...
@compliance_router.get(
    "/policies/{policy_id}", response_model=PolicyResponse, dependencies=[require_policies]
)
def get_policy(
    policy_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.post(
    "/policies/{policy_id}/submit-review",
    response_model=PolicyResponse,
    dependencies=[require_policies],
)
...
@compliance_router.post(
    "/policies/{policy_id}/approve", response_model=PolicyResponse, dependencies=[require_policies]
)
def approve_policy(
    policy_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.post(
    "/policies/{policy_id}/publish", response_model=PolicyResponse, dependencies=[require_policies]
)
def publish_policy(
    policy_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.post(
    "/policies/{policy_id}/archive", response_model=PolicyResponse, dependencies=[require_policies]
)
def archive_policy(
    policy_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.post(
    ...
    response_model=PolicyControlLinkResponse,
    dependencies=[require_policies],
)
...
@compliance_router.get(
    "/tasks", response_model=list[ComplianceTaskResponse], dependencies=[require_tasks]
)
def list_tasks(
    principal: CurrentPrincipal,
    tenant: CurrentTenant,
...
@compliance_router.get(
    "/tasks/{task_id}", response_model=ComplianceTaskResponse, dependencies=[require_tasks]
)
def get_task(
    task_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.post(
    "/tasks/{task_id}/complete", response_model=ComplianceTaskResponse, dependencies=[require_tasks]
)
def complete_task(
    task_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.get(
    "/findings", response_model=list[FindingResponse], dependencies=[require_findings]
)
def list_findings(
    principal: CurrentPrincipal,
    tenant: CurrentTenant,
...
@compliance_router.get(
    "/findings/{finding_id}", response_model=FindingResponse, dependencies=[require_findings]
)
def get_finding(
    finding_id: UUID,
    principal: CurrentPrincipal,
...
@compliance_router.get(
    "/control-statuses",
    response_model=list[ControlStatusRecordResponse],
    dependencies=[require_frameworks],
)
...
@compliance_router.put(
    "/control-statuses/{control_type}/{control_id}",
    response_model=ControlStatusRecordResponse,
    dependencies=[require_frameworks],
)
...
@compliance_router.post(
    "/jobs/run-expirations", response_model=JobExecutionResponse, dependencies=[require_frameworks]
)
def run_jobs(
    principal: CurrentPrincipal,
    tenant: CurrentTenant,
...
@compliance_router.post(
    "/cycle", response_model=ContinuousComplianceCycleResponse, dependencies=[require_frameworks]
)
